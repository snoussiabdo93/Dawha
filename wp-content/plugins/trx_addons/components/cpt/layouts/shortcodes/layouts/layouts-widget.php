...
if ( ! class_exists('TRX_Addons_SOW_Widget') ) {
	...
	class TRX_Addons_SOW_Widget_Layouts extends TRX_Addons_Widget {
		...
		function form($instance) {
			...
			do_action('trx_addons_action_before_widget_fields', $instance, 'trx_addons_sow_widget_layouts');
			...
			do_action('trx_addons_action_after_widget_title', $instance, 'trx_addons_sow_widget_layouts');
			

			$this->show_field(array('name' => 'layout',
									'title' => __('Layout:', 'trx_addons'),
									'description' => wp_kses_post( __("Select any previously created layout to insert to this sidebar", 'trx_addons')
															. '<br>'
			...
			do_action('trx_addons_action_after_widget_fields', $instance, 'trx_addons_sow_widget_layouts');
		}
	}
