...
// Add our shortcode's parameters to the translation nodes list
if ( !function_exists( 'trx_addons_wpml_elementor_widgets_to_translate' ) ) {
	...
	function trx_addons_wpml_elementor_widgets_to_translate( $nodes ) {
		...
		$sc = __( 'Yandex map', 'trx_addons' );
		$nodes['trx_sc_yandexmap'] = array(
			'conditions' => array( 'widgetType' => 'trx_sc_yandexmap' ),
			'fields'     => array_merge(
								// Shortcode-specific params
								array(
									array(
			...
			'integration-class' => 'WPML_Elementor_Trx_Sc_Yandexmap',
		);
...
// Add common title's parameters to the translation nodes list
...
// Autoload base class definitions for shortcodes with items (field type REPEATER)
