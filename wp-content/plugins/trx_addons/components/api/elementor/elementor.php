...
if ( !function_exists( 'trx_addons_elm_post_edit_link' ) ) {
	...
	function trx_addons_elm_post_edit_link( $link, $post_id ) {
		if ( trx_addons_exists_elementor() && trx_addons_is_built_with_elementor( $post_id ) ) {
...
if ( ! function_exists( 'trx_addons_elm_before_full_post_content' ) ) {
    ...
    function trx_addons_elm_before_full_post_content() {
        if ( trx_addons_exists_elementor() && trx_addons_is_built_with_elementor( get_the_ID() ) && ! has_filter( 'the_content', array( \Elementor\Plugin::$instance->frontend, 'apply_builder_in_content' ) ) ) {
...
if ( !function_exists( 'trx_addons_elementor_set_settings_icon' ) ) {
	function trx_addons_elementor_set_settings_icon( $icon ) {
		return defined( 'ELEMENTOR_VERSION' ) && version_compare( ELEMENTOR_VERSION, '2.6.0', '>=' ) ? array( 'icon' => $icon ) : $icon;
	}
}
...
// Fixes for compatibility with new versions od Elementor
//--------------------------------------------------------
