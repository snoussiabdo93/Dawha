...
?>">
	<?php
if (!empty($meta['inverse_image'])) {
	?><div class="sc_properties_item_image" title="<?php  esc_attr_e('Image', 'heaven11'); ?>" style="background-image: url('<?php trx_addons_show_layout($meta['inverse_image']); ?>');"></div><?php
}
	// Featured image
		...
		trx_addons_get_template_part('templates/tpl.featured.php',
										...
										apply_filters('trx_addons_filter_args_featured', array(
															...
															'thumb_size' => apply_filters('trx_addons_filter_thumb_size',
																							trx_addons_get_thumb_size((int)$args['columns'] > 2 ? 'propert' : 'big'),
																							'properties-default'),
	...
	?><div class="sc_properties_item_info">
		<div class="sc_properties_item_header"><?php
			// Title
			?><h6 class="sc_properties_item_title"><a href="<?php echo esc_url($link); ?>"><?php the_title(); ?></a></h6><?php
			// Status
			...
			?><span class="sc_properties_item_compare trx_addons_icon-balance-scale<?php
					...
					title="<?php esc_attr_e('Add to compare list', 'heaven11'); ?>"></span>
		</div>
		<div class="sc_properties_item_options">
			<div class="sc_properties_item_row sc_properties_item_row_info"><?php
				// Year built
				if (!empty($meta['built'])) {
					?><span class="sc_properties_item_option sc_properties_item_built" title="<?php  esc_attr_e('Year built', 'heaven11'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-building"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Built:', 'heaven11'); ?></span>
						</span>
				...
				if (!empty($meta['area_size'])) {
					?><span class="sc_properties_item_option sc_properties_item_area alter_item" title="<?php  esc_attr_e('Area size', 'heaven11'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-resize-full-alt"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Area:', 'heaven11'); ?></span>
						</span>
			...
			<div class="sc_properties_item_row sc_properties_item_row_info"><?php
				...
				if (!empty($meta['bathrooms'])) {
					?><span class="sc_properties_item_option sc_properties_item_bathrooms" title="<?php  esc_attr_e('Bathrooms number', 'heaven11'); ?>">
					    <span class="sc_properties_item_option_label">
					    ...
					    <span class="sc_properties_item_option_label_text"><?php esc_html_e('Bathroom', 'heaven11'); ?></span>
					</span><?php
				}
				// Bedrooms
				if (!empty($meta['bedrooms'])) {
					?><span class="sc_properties_item_option sc_properties_item_bedrooms" title="<?php  esc_attr_e('Bedrooms number', 'heaven11'); ?>">
						<span class="sc_properties_item_option_label">
					    ...
					    <span class="sc_properties_item_option_label_text"><?php esc_html_e('Bedrooms', 'heaven11'); ?></span>
					</span><?php
				}
				// Area size
				if (!empty($meta['area_size'])) {
					?><span class="sc_properties_item_option sc_properties_item_area" title="<?php  esc_attr_e('Area size', 'heaven11'); ?>">
					    <span class="sc_properties_item_option_label">
				...
				if (!empty($meta['garages'])) {
					?><span class="sc_properties_item_option sc_properties_item_garages" title="<?php  esc_attr_e('Garages number and size', 'heaven11'); ?>">
						<span class="sc_properties_item_option_label">
						...
						?></span>
					    <span class="sc_properties_item_option_label_text"><?php esc_html_e('Garages', 'heaven11'); ?></span>
					</span><?php
				}
			?></div><?php
			...
			<div class="sc_properties_item_row sc_properties_item_row_address"><?php
				// Address
				?><span class="sc_properties_item_option sc_properties_item_address" title="<?php  esc_attr_e('Address', 'heaven11'); ?>">
					<span class="sc_properties_item_option_label">
						<span class="sc_properties_item_option_label_icon trx_addons_icon-home"></span>
						<span class="sc_properties_item_option_label_text"><?php esc_html_e('Address:', 'heaven11'); ?></span>
					</span>
					<span class="sc_properties_item_option_data"><?php 
			...
			<div class="sc_properties_item_row sc_properties_item_row_meta"><?php
				...
				if ($meta['agent_type']!='none' && ($meta['agent_type']=='author' || $meta['agent']!=0)) {
					?><span class="sc_properties_item_option sc_properties_item_author" title="<?php  esc_attr_e('Agent or post author', 'heaven11'); ?>">
						<span class="sc_properties_item_option_label">
							<span class="sc_properties_item_option_label_icon trx_addons_icon-user-alt"></span>
							<span class="sc_properties_item_option_label_text"><?php esc_html_e('Agent:', 'heaven11'); ?></span>
						</span>
						<span class="sc_properties_item_option_data"><?php
				...
				// Publish date
				?><span class="sc_properties_item_option sc_properties_item_date" title="<?php  esc_attr_e('Publish date', 'heaven11'); ?>">
					<span class="sc_properties_item_option_label">
						<span class="sc_properties_item_option_label_icon trx_addons_icon-calendar"></span>
						<span class="sc_properties_item_option_label_text"><?php esc_html_e('Added:', 'heaven11'); ?></span>
					</span>
					<span class="sc_properties_item_option_data"><?php
			...
			?></div><?php
			// Title
			?><h6 class="sc_properties_item_title default-title"><a href="<?php echo esc_url($link); ?>"><?php the_title(); ?></a></h6>
			<div class="sc_properties_item_price_related"><?php
				...
				?></div>
			<div class="sc_properties_item_excerpt"><?php the_excerpt(); ?></div>
			<div class="sc_properties_item_button_related sc_item_button"><a href="<?php echo esc_url($link); ?>" class="<?php echo esc_attr(apply_filters('trx_addons_filter_sc_item_link_classes', 'sc_button', 'sc_properties', $args)); ?>"><?php esc_html_e('Get details', 'heaven11'); ?></a></div><?php
