...
?>>
	<form class="properties_search_form sc_form_form sc_form_custom <?php if ($form_style != 'default') echo 'sc_input_hover_'.esc_attr($form_style); ?>" action="<?php echo esc_url(get_post_type_archive_link( TRX_ADDONS_CPT_PROPERTIES_PT )); ?>" method="get">
		...
		<div class="properties_search_basic"><?php
			...
			trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
											...
											array_merge($trx_addons_args, array(
														...
														'field_title' => esc_html__('Search for', 'heaven11'),
														'field_placeholder' => esc_attr__('Enter an address, ZIP or property ID', 'heaven11')
														))
										);
		
			// Show Advanced Search
			?><div class="properties_search_show_advanced trx_addons_icon-sliders" title="<?php esc_attr_e('Show advanced search', 'heaven11'); ?>"></div><?php

			// Basic Submit button
			?><button class="properties_search_button trx_addons_icon-search" title="<?php esc_attr_e('Start search', 'heaven11'); ?>"></button><?php
		...
		<div class="properties_search_advanced"><?php
			...
			$list = trx_addons_array_merge(array(0 => esc_html(sprintf(__('- %s -', 'heaven11'), $tax_obj->label))),
			...
			trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
											...
											array_merge($trx_addons_args, array(
														'labels'      => true,
														'field_title' => esc_html__('Bedrooms', 'heaven11'),
			...
			trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
											...
											array_merge($trx_addons_args, array(
														'labels'      => true,
														'field_title' => esc_html__('Bathrooms', 'heaven11'),
			...
			trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
											...
											array_merge($trx_addons_args, array(
														'labels'      => true,
														'field_title' => esc_html__('Area size (m2)', 'heaven11'),
			...
			trx_addons_get_template_part(TRX_ADDONS_PLUGIN_SHORTCODES . 'form/tpl.form-field.php',
											...
											array_merge($trx_addons_args, array(
														'labels'      => true,
														'field_title' => esc_html__('Price ($)', 'heaven11'),
