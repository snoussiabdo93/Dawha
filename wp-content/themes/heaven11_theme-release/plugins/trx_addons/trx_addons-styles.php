...
if ( ! function_exists( 'heaven11_trx_addons_add_theme_vars' ) ) {
	add_filter( 'heaven11_filter_add_theme_vars', 'heaven11_trx_addons_add_theme_vars', 10, 2 );
	function heaven11_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'heaven11_trx_addons_get_css' ) ) {
	add_filter( 'heaven11_filter_get_css', 'heaven11_trx_addons_get_css', 10, 2 );
	function heaven11_trx_addons_get_css( $css, $args ) {
...
.sc_slider_controls .slider_controls_wrap>a.slider_prev:hover:before,
.sc_slider_controls .slider_controls_wrap>a.slider_next:hover:after {
    background-color: {$colors['text_hover']};
}
...
.sc_recent_news .post_item .post_featured .post_info .post_excerpt {
    color:{$colors['text_light']};
}
...
.sc_blogger_item_on_plate.sc_blogger_item_default .sc_blogger_item_excerpt:after {
...
.sc_icons_alter.sc_icons .sc_icons_item_title,
.sc_icons_simple.sc_icons .sc_icons_item_title,
...
.sc_price_item .sc_price_item_details ul.trx_addons_list_extra[class*="trx_addons_list"] {
	color: {$colors['extra_dark']};
}
...
.widget_properties_compare .properties_compare_list > li:hover {
	border-color: {$colors['text_dark']};
}
...
.sc_services_tabs_content_image img {
    border-color: {$colors['bg_color']};
}
.sc_services_tabs_simple .sc_services_tabs_list_item.sc_services_tabs_list_item_active:before,
.sc_services_tabs_simple .sc_services_tabs_list_item:hover:before {
    border-color: {$colors['text_hover']};
}
