...
if ( ! function_exists( 'heaven11_date_time_picker_field_get_css' ) ) {
	add_filter( 'heaven11_filter_get_css', 'heaven11_date_time_picker_field_get_css', 10, 2 );
	function heaven11_date_time_picker_field_get_css( $css, $args ) {
